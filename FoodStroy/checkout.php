...
if(isset($_POST['submit'])){
    ...
    mysqli_query($con,"INSERT into `order`(user_id,name,mobile,address,city,pincode,payment_type,payment_status,order_status,added_on,total_price,coupon_id,coupon_code,coupon_value) values('$user_id','$name','$mobile','$address','$city','$pincode','$payment_type','$payment_status','$order_status','$added_on','$total_price','$coupon_id','$coupon_code','$coupon_value')");
